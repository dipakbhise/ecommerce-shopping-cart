...
const Header = () => {
  ...
  <LinkContainer to="/ecommerce-shopping-cart" exact>
    ...
    <Form inline className="m-auto w-50">
      <FormControl type="text" placeholder="Search" className="mr-sm-2 px-5 w-75" />
      <Button variant="outline-light" className="text-light bg-primary">Search</Button>
      
    </Form>

    <NavLink to="/cart" className="btn text-secondary bg-light mx-5 px-2 ">Total Items In Cart <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-cart" viewBox="0 0 16 16">
